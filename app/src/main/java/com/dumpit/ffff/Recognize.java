 ...
 * Use the {@link Recognize#newInstance} factory method to
...
public class Recognize extends Fragment {
     ...
     * @return A new instance of fragment Recognize.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup)inflater.inflate(R.layout.fragment_recognize, container, false);
        ////
        MobileAds.initialize(getContext(), new OnInitializationCompleteListener() { //광고 초기화
            @Override
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                viewGroup.findViewById(R.id.save).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ////
                        Toast.makeText(getActivity().getApplicationContext(), "50p 적립!", Toast.LENGTH_SHORT).show();
                        ////
    ...
    PermissionListener permissionListener = new PermissionListener() {
        ...
        public void onPermissionDenied(ArrayList<String> deniedPermissions) {
            ...
            ////
            Toast.makeText(getActivity().getApplicationContext(), "카메라 촬영을 원하시면 설정->어플리케이션->dumpit에 들어가서\n 카메라 권한을 허용해주세요", Toast.LENGTH_SHORT).show();
        }
    };
